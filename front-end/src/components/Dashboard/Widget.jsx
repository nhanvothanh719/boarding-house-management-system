    ...
    switch (this.state.type) {
      case "renter":
        data = {
          ...
          widgetIcon: <PersonAddAltIcon className="widgetIcon" 
          style={{
            color: "crimson",
      ...
      case "room":
        data = {
          ...
          isMoney: false,
          linkDescription: "View all",
          widgetIcon: <BedIcon className="widgetIcon" 
          style={{
            color: "purple",
      ...
      case "earning":
        data = {
          ...
          widgetIcon: <AccountBalanceWalletOutlinedIcon className="widgetIcon" 
          style={{
            color: "green",
      ...
      case "balance":
        data = {
          ...
          isMoney: true,
          linkDescription: "View details",
          widgetIcon: <AttachMoneyIcon className="widgetIcon" 
          style={{
            color: "goldenrod",
      ...
      <Fragment>
        <div className="widget">
            ...
            <div className="widgetRight">
                {data.widgetIcon}
            <Link to="/" className="widgetLink">{data.linkDescription}</Link>
            </div>
        </div>
      </Fragment>
    )
