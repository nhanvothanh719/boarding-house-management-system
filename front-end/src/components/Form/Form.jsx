                    ...
                    <div className="bottomRightContainer">
                        <form className="flexForm">
                            <div className="formInput">
                                ...
                                <input type="text" placeholder='Nguyen Van A' className="inputItem"/>
                            </div>
                            <div className="formInput">
                                <label className="inputItemLabel">Email:</label>
                                <input type="email" placeholder='admin@gmail.com' className="inputItem"/>
                            </div>
                            <div className="formInput">
                            ...
                            <div className="formInput">
                                ...
                                <input type="text" placeholder='0960000001' className="inputItem"/>
                            </div>
                            <div className="formInput">
                                <label className="inputItemLabel">Permanent address:</label>
                                <input type="text" placeholder='Elton St. 216 NewYork' className="inputItem"/>
                            </div>
                            <div className="formInput">
