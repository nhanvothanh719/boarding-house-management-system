...
import { faFacebook, faGithubSquare, faGoogle, faGooglePlus, faInstagram } from '@fortawesome/free-brands-svg-icons';
import { faEnvelopeOpen, faHome, faMailBulk, faMailReply, faPhone, faSave } from "@fortawesome/free-solid-svg-icons";
        ...
        <Container fluid="true" className='footerSection'>
            <Row>
                ...
                <Col lg={4} md={6} sm={12} className='p-3'>
                    <h2 className="footerText text-center">Contact address</h2>
                    <hr className="bg-white" />
                ...
                <Col lg={3} md={6} sm={12} className='p-3'>
                    <h2 className="footerText text-center">Address</h2>
                    <hr className="bg-white" />
                ...
                <Col lg={2} md={6} sm={12} className='p-3'>
                    <h2 className="footerText text-center">Policy</h2>
                    <hr className="bg-white" />
